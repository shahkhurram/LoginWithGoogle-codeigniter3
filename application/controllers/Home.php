<?php 
	...
	class Home extends CI_Controller{
		...
		public function google_login(){
			...
			$client->setApplicationName('gmail verify');
			$client->setClientId('404163321921-3cd8suqk809entgs5m8g4ltdh3qvla4v.apps.googleusercontent.com');
			$client->setClientSecret('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');
